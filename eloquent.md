...
Given validated and purposefully pre-permuted parameters it is also possible to create instances directly, while taking advantage of the model features and rules (guarded/fillable attributes, dates, mutators/accessors, timestamps) from an associative array where the keys correspond to fillable attribute columns:
